...
}).prototype = getMCSymbolPrototype(lib.two, new cjs.Rectangle(0,0,159.5,121.5), null);
...
}).prototype = getMCSymbolPrototype(lib.three, new cjs.Rectangle(-0.5,0,168,137.5), null);
...
}).prototype = getMCSymbolPrototype(lib.one, new cjs.Rectangle(0,0,212,117.5), null);
...
// stage content:
(lib._25000NEW59797CHIDrStadlerMedScapeDigitalAds_300x250 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.instance.setTransform(11.7,14.9,0.1905,0.1905);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(335));

	// three
	this.instance_1 = new lib.three();
	this.instance_1.setTransform(108.3,154.75,1,1,0,0,0,83.4,68.6);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(104).to({_off:false},0).to({alpha:1},25,cjs.Ease.quintInOut).wait(190).to({alpha:0},11).wait(5));

	// two
	this.instance_3 = new lib.two();
	this.instance_3.setTransform(103.1,147.1,1,1,0,0,0,79.7,60.8);
	this.instance_3.alpha = 0;
	this.instance_3._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(104).to({_off:false},0).to({alpha:1},25,cjs.Ease.quintInOut).wait(47).to({alpha:0},16,cjs.Ease.quintInOut).to({_off:true},6).wait(137));

	// one
	this.instance_4 = new lib.one();
	this.instance_4.setTransform(130.4,145.3,1,1,0,0,0,106,58.9);
	this.instance_4.alpha = 0;
	this.instance_4._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(5).to({_off:false},0).to({alpha:1},38).wait(36).to({alpha:0},22).to({_off:true},3).wait(231));

	// bg
	this.shape = new cjs.Shape();
	this.shape.graphics.lf(["#2567A6","#286BA9","#3076B0","#3E89BD","#51A4D0","#6AC6E7","#FFF9B8"],[0,0.157,0.302,0.447,0.584,0.725,1],107.5,107.5,-147.2,-147.2).s().p("A3bTiMAAAgnDMAu3AAAMAAAAnDg");
...
an.compositions['A5AB2BACC72E4C83915CCF4811BE1CE6'] = {
